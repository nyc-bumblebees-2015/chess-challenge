...
__END__
    it "makes legal moves" do
      ...
      chess_board.board_move("D4","G7")

      expect(chess_board.board["D4"]).to be nil
      expect(chess_board.board["G7"]).to be bishop
    end
    ...
    it "does not make illegal moves" do
      ...
      expect(chess_board.board["D4"]).to be bishop
      expect(chess_board.board["G7"]).to_not be nil
    end
  end
end
